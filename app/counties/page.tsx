    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Counties</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {counties.map((county) => (
              <Link
                key={county.code}
                href={county.link}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg hover:border-ecitizen-green transition-all group"
              >
                <div className="flex items-center justify-center mb-4">
                  <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center border-2 border-gray-300">
                    <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-inner">
                      <span className="text-xl font-bold text-gray-600">{county.code}</span>
                    </div>
                  </div>
                </div>
                <h3 className="text-base font-semibold text-gray-900 text-center group-hover:text-ecitizen-green">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg">
              <div className="w-16 h-16 mb-6 mx-auto flex items-center justify-center">
                <svg className="w-16 h-16 text-ecitizen-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
